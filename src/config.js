...
export const STANDS = [
  ...
  },
  {
    ...
    premio: { nombre: "Premio Confío Pagos", descripcion: "Descripción del premio de Confío Pagos (pendiente por definir)." },
    preguntas: [
      {
  ...
  },
  {
    ...
    premio: { nombre: "Premio ATOM", descripcion: "Descripción del premio de ATOM (pendiente por definir)." },
  ...
  },
  {
    ...
    premio: { nombre: "Premio Chatea Pro", descripcion: "Descripción del premio de Chatea Pro (pendiente por definir)." },
    preguntas: [
      {
  ...
  }, 
  {
    ...
    bienvenida: "En Groupack **importas sin arriesgar** capital en inventario parado.\n\nResponde 2 preguntas sobre tu experiencia **importando** y tus ventas, y desbloquea increíbles **beneficios.**", // mensaje de bienvenida personalizado de esta marca (cuando lo tengas)
    mensajeExito: "1. **Bono logístico** (flete) de 400 mil pesos en tu primera importación.\n\n2. **Cotización gratis** de tus primeros 10 productos.\n\n3. Financiación de 5 millones **sujeto a restricciones.**", // mensaje que se muestra al desbloquear el logro de esta marca (cuando lo tengas)
    premio: { nombre: "Premio Groupack", descripcion: "Descripción del premio de Groupack (pendiente por definir)." },
    preguntas: [
      {
