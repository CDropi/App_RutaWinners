...
//
//    ⚠️ ANTES DE SUBIR A PRODUCCIÓN: esto TIENE que quedar en `false`.
//    Con `true` no se lee ni se escribe nada en Firebase, así que el
//    registro que ya está al aire dejaría de funcionar: los asistentes no
//    aparecerían y las entradas, el progreso de la ruta, Academy y los
//    premios se guardarían solo en el navegador de cada persona.
//    Además habilita los atajos de prueba del mapa (completar los 7 stands
//    y reiniciar el progreso), que no deben quedar visibles en el evento.
