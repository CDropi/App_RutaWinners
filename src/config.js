...
export const PUNTO_ACADEMY = {
  ...
  // El contenido de las PANTALLAS de Academy (bienvenida, camino,
  // misiones) vive en src/data/academyDatos.js: son muchas pantallas con
  // bastante texto. Acá queda solo lo que necesita el punto del mapa.
};
...
// 5) FECHA "QUEMADA" PARA PROBAR — el interruptor más importante de este
//    archivo antes del evento.
//
//    Con un valor puesto, toda la app cree que hoy es ese día: no hay que
//    esperar al 12 de septiembre ni cambiarle el reloj al celular.
//
//    Los dos valores útiles para este evento:
//      export const FECHA_SIMULADA_HOY = "2026-09-12"; // Día 1
//      export const FECHA_SIMULADA_HOY = "2026-09-13"; // Día 2
//
//    Qué cambia al ponerla:
//      1. La validación del QR en la app del staff. Un ticket del Día 1
//         escaneado con la fecha en "2026-09-13" se rechaza con
//         "dia_incorrecto", y viceversa. Es la única forma de probar esa
//         validación antes del evento.
//      2. Perfil y Ruta Winner. Las dos pestañas quedan bloqueadas
//         (pantalla "Sección no disponible") hasta que la fecha efectiva
//         sea uno de los días del evento. Con la fecha quemada se pueden
//         revisar sin esperar.
//
//    ⚠️ ANTES DEL EVENTO REAL ESTO TIENE QUE VOLVER A `null`. Si se queda
...
//
//    En `false` basta con que sea uno de los días del evento: cualquiera
