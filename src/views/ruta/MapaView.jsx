...
import { LOGO_APP, IMAGEN_MAPA_PLANO, STANDS, PUNTO_ACADEMY } from '../../config.js';
import { textoSobre } from '../../utils/color.js';
import '../../styles/mapa.css';

export default function MapaView({ onIniciar, standsCompletados, premios, onAbrirPremios, onAbrirAcademy, academyCompletada = false }) {
