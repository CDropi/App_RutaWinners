...
import { IMAGEN_FONDO_LOGIN, LOGO_LOGIN, EVENTO, STANDS } from '../config.js';
import {
...
function ScannerView({ usuario, onLogout }) {
  ...
  // ---- Vista de consulta de la Ruta Winner (premios + Academy) ----
  const [vistaPremios, setVistaPremios] = useState(false);
  const [premiosBusqueda, setPremiosBusqueda] = useState('');
  const [premiosResultado, setPremiosResultado] = useState(null); // { persona, standsCompletados, academyCompletada, premios } | null
    ...
    <>
      ...
      <div id="scannerView" style={{ display: 'flex' }}>
        <div className="staff-header">
          ...
          <button className="staff-detalle-download" onClick={() => setVistaPremios(true)} aria-label="Consultar premios de una persona">
          ...
          <div className="staff-detalle-panel">
            ...
            <div className="staff-detalle-header">
              <div>
                ...
                <div className="staff-detalle-title">Consulta de premios</div>
              </div>
            </div>
